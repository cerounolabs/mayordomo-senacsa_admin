...
?>
                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="form-group">
                                                <label for="var05">DOCUMENTO NRO</label>
                                                <input id="var05" name="var05" class="form-control" type="text" style="text-transform:uppercase; height:40px;" placeholder="DOCUMENTO NRO" value="<?php echo $row_05; ?>" required <?php echo $workReadonly; ?>>
                                            </div>
                                        </div>
                                    </div>
