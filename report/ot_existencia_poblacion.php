<?php
    ...
    if ($workCodigo <> 0){
        ...
        $mpdf -> WriteHTML('<body>');
        $mpdf -> WriteHTML('<br>');
        $mpdf -> WriteHTML('<h2 style="margin:0px;">EXISTENCIA POR POBLACIÓN</h2>');
        $mpdf -> WriteHTML('<br>');
                            ...
                            if ($row_subcategoria_02 == 'ANIMALSUBCATEGORIA'){
                                if ($otAudJSON['code'] == 200) {
                                    ...
                                    foreach ($otAudJSON['data'] as $ot_auditadaKey=>$ot_auditadaArray) {
                                        ...
                                        if ($row_auditada_02 == $row_categoria_00 && $row_auditada_04 == $row_subcategoria_00 && $row_auditada_06 == $row_ot_07){
        ...
        $mpdf -> Output('otExistenciaPorPoblacion.pdf', 'I');
        exit;
    }
?>